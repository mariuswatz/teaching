 ...
 * @webref
 */
public class SerialHack implements SerialPortEventListener {
  ...
  public SerialHack(PApplet parent) {
    this(parent, dname, drate, dparity, ddatabits, dstopbits);
  }

  public SerialHack(PApplet parent, int irate) {
    this(parent, dname, irate, dparity, ddatabits, dstopbits);
  }

  public SerialHack(PApplet parent, String iname, int irate) {
    this(parent, iname, irate, dparity, ddatabits, dstopbits);
  }

  public SerialHack(PApplet parent, String iname) {
  ...
  public SerialHack(PApplet parent, String iname, int irate,
    ...
    System.out.println("processing.serial.SerialHack - MW hack.");
  ...
  */
  ...
  static public void errorMessage(String where, Throwable e) {
    ...
    e.printStackTrace();
    throw new RuntimeException("Error inside SerialHack." + where + "()");
  }


	public static void addError(String where, Throwable e) {
  	hasError=true;

  	String str=e.toString();
  	if(e.getCause()!=null) str+=" Cause: "+e.getCause().getMessage();
  	str=where+"\n"+str;
